...
{
    public partial class AddApplicationRoleDescription : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArquivoECD = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Exercicio", x => x.ExercicioId);
                    table.ForeignKey(
                        name: "FK_Exercicio_Empresa_EmpresaId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Exercicio_EmpresaId_Ano",
                table: "Exercicio",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "UsuarioClaim");
            migrationBuilder.DropTable(name: "UsuarioLogin");
            migrationBuilder.DropTable(name: "UsuarioRole");
            migrationBuilder.DropTable(name: "UsuarioToken");
            migrationBuilder.DropTable(name: "Exercicio");
